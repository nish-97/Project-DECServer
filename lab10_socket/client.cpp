...
int main(int argc, char *argv[])
{
    ...
    if (requestType == "new")
    {
        ...
        cout << "File Size "<<fileSize << " sent to the server"<<endl;
        ...
        cout << "Source Code file sent to the server "<<endl;
        ...
        {
            buffer[bytesRead] = '\0';
            cout << "ID Recieved is "<< buffer << endl;
        }
    ...
    else if (requestType == "status")
    {
            ...
            cout<<"Status Request For "<< sourceFileOrRquestId<<" sent to the server"<<endl;
